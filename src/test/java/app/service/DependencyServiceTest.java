...
public class DependencyServiceTest {
    ...
    public void init() {
        initMocks(this);
        when(readerService.getSourceDependencies()).thenReturn(Arrays.asList(DEP_STR_1, DEP_STR_2, DEP_STR_3, DEP_STR_4, DEP_STR_5));
        dependencyService = new DependencyService(readerService);
    }
    ...
    public static class DependencyParserTest {
        ...
        @Before
        public void init() {
            dependencyService = new DependencyService(mock(ReaderService.class));
        }
